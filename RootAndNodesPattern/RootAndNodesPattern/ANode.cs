...
namespace TeoVincent.RootAndNodesPattern
{
    public abstract class ANode
    {
        ...
        protected ANode(Root a_root, string a_name)
        {
            if (a_root == null)
        ...
        public void JoinChildNode(string a_parentOutput, ANode a_nodeChild)
        {
        ...
        public void JoinChildNode(ANode a_nodeChild)
        {
        ...
        public ANode GetChildNode(string a_outputName)
        {
